...
public class DashboadTeacher extends javax.swing.JFrame {
    public int idAcc;
    ...
    public DashboadTeacher(int data) {
        initComponents();
        idAcc = data;
        DefaultColor = new Color(255,255,255);
        ClickedColor = new Color(255,152,51);
    ...
    private void home3MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_home3MouseClicked
        SideBarManageClasses manageClaases = new SideBarManageClasses(idAcc);
        jDesktopPanel.removeAll();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DashboadTeacher().setVisible(true);
            }
        });
    }
